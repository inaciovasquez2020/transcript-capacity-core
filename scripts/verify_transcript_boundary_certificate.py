...
from transcript_boundary_certificate import transcript_boundary_certificate
...
def main() -> int:
    doc = ROOT / "docs/status/TRANSCRIPT_BOUNDARY_CERTIFICATE.md"
    source = ROOT / "src/transcript_boundary_certificate.py"
    status = ROOT / "STATUS.md"
    if not status.exists():
        status = ROOT / "README.md"
    require(doc.exists(), "missing transcript boundary certificate doc")
